...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2025 at 09:34 PM
...
CREATE TABLE `careers` (
  ...
  `type` enum('active','inactive') NOT NULL DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `careers` (`id`, `title`, `details`, `type`, `created_at`, `updated_at`) VALUES
(1, 'Jr laravel developer', '<h4>📌 <strong>Job Title:</strong></h4><p><strong>Junior Laravel Developer</strong></p><h4>📌 <strong>Job Description:</strong></h4><p>We are looking for a passionate <strong>Junior Laravel Developer</strong> to help build and maintain web applications using Laravel. You will work with senior developers to write clean, efficient code, troubleshoot issues, and implement new features.</p><h4>📌 <strong>Key Responsibilities:</strong></h4><p>Develop, test, and maintain Laravel-based applications.</p><p>Write clean, secure, and reusable code.</p><p>Assist in database design and optimization.</p><p>Collaborate with designers and other developers.</p><p>Debug and troubleshoot issues quickly.</p><p>Follow best practices in coding and security.</p><h4>📌 <strong>Requirements:</strong></h4><p>Basic experience with PHP and Laravel.</p><p>Understanding of MVC architecture.</p><p>Familiarity with MySQL or other databases.</p><p>Basic knowledge of HTML, CSS, JavaScript.</p><p>Eagerness to learn and improve.</p><p>Good problem-solving skills.</p><h4>📌 <strong>Nice to Have:</strong></h4><p>Experience with REST APIs.</p><p>Knowledge of version control (Git).</p><p>Understanding of front-end frameworks.</p><h4>📌 <strong>Benefits:</strong></h4><p>Friendly team environment.</p><p>Opportunity to learn and grow.</p><p>Exposure to real-world projects.</p>', 'active', '2025-07-07 13:08:07', '2025-07-07 13:29:26'),
(2, 'laravel developer (intern)', '<h4>📌 <strong>Job Title:</strong></h4><p><strong>Junior Laravel Developer</strong></p><h4>📌 <strong>Job Description:</strong></h4><p>We are looking for a passionate <strong>Junior Laravel Developer</strong> to help build and maintain web applications using Laravel. You will work with senior developers to write clean, efficient code, troubleshoot issues, and implement new features.</p><h4>📌 <strong>Key Responsibilities:</strong></h4><p>Develop, test, and maintain Laravel-based applications.</p><p>Write clean, secure, and reusable code.</p><p>Assist in database design and optimization.</p><p>Collaborate with designers and other developers.</p><p>Debug and troubleshoot issues quickly.</p><p>Follow best practices in coding and security.</p><h4>📌 <strong>Requirements:</strong></h4><p>Basic experience with PHP and Laravel.</p><p>Understanding of MVC architecture.</p><p>Familiarity with MySQL or other databases.</p><p>Basic knowledge of HTML, CSS, JavaScript.</p><p>Eagerness to learn and improve.</p><p>Good problem-solving skills.</p><h4>📌 <strong>Nice to Have:</strong></h4><p>Experience with REST APIs.</p><p>Knowledge of version control (Git).</p><p>Understanding of front-end frameworks.</p><h4>📌 <strong>Benefits:</strong></h4><p>Friendly team environment.</p><p>Opportunity to learn and grow.</p><p>Exposure to real-world projects.</p>', 'active', '2025-07-07 13:29:37', '2025-07-07 13:33:25');
...
INSERT INTO `clientcontacts` (`id`, `name`, `phone`, `service`, `location`, `created_at`, `updated_at`) VALUES
(4, 'Sabbir', '01751155302', 'Bedbugs Control Services', 'uttra Bns', '2025-07-07 10:27:50', '2025-07-07 10:27:50');

-- --------------------------------------------------------

--
-- Table structure for table `codepushes`
--

CREATE TABLE `codepushes` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `codepushes`
--

INSERT INTO `codepushes` (`id`, `header`, `body`, `footer`, `created_at`, `updated_at`) VALUES
(1, '<!-- Google tag (gtag.js) -->\r\n<script async src=\"https://www.googletagmanager.com/gtag/js?id=AW-17322872519\"></script>\r\n<script>\r\n  window.dataLayer = window.dataLayer || [];\r\n  function gtag(){dataLayer.push(arguments);}\r\n  gtag(\'js\', new Date());\r\n\r\n  gtag(\'config\', \'AW-17322872519\');\r\n</script>', NULL, NULL, NULL, '2025-07-07 12:29:10');
...
(24, '2025_07_07_151502_create_clientcontacts_table', 9),
(25, '2025_07_07_160255_create_codepushes_table', 10),
(27, '2025_07_07_184704_create_careers_table', 11);
...
--
-- Indexes for table `codepushes`
--
ALTER TABLE `codepushes`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `codepushes`
--
ALTER TABLE `codepushes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
