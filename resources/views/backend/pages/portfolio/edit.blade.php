        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form method="post" action="{{ route('portfolioupdate', $portfolio->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                                ...
                                <select name="service" id="type" class="form-control">
                                    @foreach ($cleaning as $item)
                                        <option value="{{ $item->name }}"
                                            {{ $item->name == $portfolio->service ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{ asset('image/portfolio/' . $portfolio->img) }}" alt="" width="150">
                            </div>
                        </div>
