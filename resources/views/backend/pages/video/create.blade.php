        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form method="post" action="{{ route('videostore') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="input35" class="col-sm-3 col-form-label">video embedid</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="embedid">
                            </div>
                        </div>
