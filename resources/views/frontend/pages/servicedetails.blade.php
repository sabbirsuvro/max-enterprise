            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-8">
                    <div class="page-single mb-30">
                        <div class="page-img"><img src="{{ asset('image/cleaning/' .$cleaning->img) }}" alt="Service Image" />
                        </div>
                        <div class="page-content">
                            <h2 class="sec-title page-title">{{ $cleaning->name }}</h2>
