            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-8">
                    <div class="page-single mb-30">
                        <div class="page-img"><img src="{{ asset('image/manpower/' .$manpower->img) }}" alt="Service Image" />
                        </div>
                        <div class="page-content">
                            <h2 class="sec-title page-title">{{ $manpower->name }}</h2>
                ...
                <div class="col-xxl-4 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_categories">
                            <ul>
                                @foreach ($manpowerlist as $item)
                                <li>
                                    <a href="{{ route('manpowerdetails',$item->id) }}">{{ $item->name }}</a> <span><i
